...
MouseArea {
    ...
    property bool monitorIsFocused: false // Set by WallpaperSelector.qml parent
                ...
                Item {
                    ...
                    GridView {
                        ...
                        delegate: WallpaperDirectoryItem {
                            ...
                            // Per-monitor apply buttons (1, 2, 3…)
                            Row {
                                anchors {
                                    top: parent.top
                                    right: parent.right
                                ...
                                spacing: 6
                                z: 100
                                visible: parent.containsMouse || index === grid.currentIndex
                                ...
                                Repeater {
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        RippleButton {
                                            ...
                                            onClicked: {
                                                Wallpapers.apply(fileModelData.filePath, root.useDarkMode, modelData.name);
                                            }
                                            StyledText {
                                                anchors.centerIn: parent
                                                text: index + 1
