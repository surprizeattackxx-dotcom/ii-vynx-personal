                ...
                Item {
                    ...
                    StyledFlickable { // Notification actions
                        ...
                        RowLayout {
                            ...
                            // Reply button — always shown so any notification can be replied to
                            NotificationActionButton {
                                Layout.fillWidth: true
                                urgency: notificationObject.urgency
                                implicitWidth: contentItem.implicitWidth + leftPadding + rightPadding
                                onClicked: Notifications.startReply(notificationObject.notificationId, root.popup ? "popup" : "sidebar")
                            ...
                            Repeater {
                                id: actionRepeater
                                model: notificationObject.actions.filter(a => a.identifier !== "inline-reply" && a.identifier !== "reply")
                                NotificationActionButton {
                                    id: notifAction
